...
$(ObjDir)/constraint_layer_test.cpp_pre.cpp.tb.o : constraint_layer_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling constraint_layer_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/constraint_layer.cpp_pre.cpp.tb.o : constraint_layer.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling constraint_layer.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/fxp_sqrt_top.cpp_pre.cpp.tb.o : fxp_sqrt_top.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling fxp_sqrt_top.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \
