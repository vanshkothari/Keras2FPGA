...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "constraint_layer_top.autotvin.dat"
	set constFileTvOut       "constraint_layer_top.autotvout.dat"
	set constFileHdlTvIn     "constraint_layer_top.autohdltvin.dat"
	set constFileHdlTvOut    "constraint_layer_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
