...
if {[file isfile constraint_layer_top.autotvin.dat]} {
	file delete -force constraint_layer_top.autotvin.dat
}

if {[file isfile constraint_layer_top.autotvout.dat]} {
	file delete -force constraint_layer_top.autotvout.dat
}
