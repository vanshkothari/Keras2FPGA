...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.constraint_layer_top.autotvin_encoded_input_0.dat"
         "c.constraint_layer_top.autotvin_encoded_input_1.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.constraint_layer_top.autotvout_encoded_output_0.dat"
         "rtl.constraint_layer_top.autotvout_encoded_output_1.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
