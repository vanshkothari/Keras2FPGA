...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "decoder.autotvin.dat"
	set constFileTvOut       "decoder.autotvout.dat"
	set constFileHdlTvIn     "decoder.autohdltvin.dat"
	set constFileHdlTvOut    "decoder.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
