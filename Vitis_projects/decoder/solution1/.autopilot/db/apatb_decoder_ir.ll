...
define void @apatb_decoder_ir(%"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="2" "partition" %input_24, %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull "fpga.decayed.dim.hint"="16" %layer5_out) local_unnamed_addr #0 {
entry:
  %input_24_copy_0 = alloca i16, align 512
  %input_24_copy_1 = alloca i16, align 512
  %layer5_out_copy3 = alloca i256, align 512
  %0 = bitcast %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* %input_24 to [2 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]*
  %1 = bitcast %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* %layer5_out to [16 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]*
  call void @copy_in([2 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %0, i16* nonnull align 512 %input_24_copy_0, i16* nonnull align 512 %input_24_copy_1, [16 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %1, i256* nonnull align 512 %layer5_out_copy3)
  call void @apatb_decoder_hw(i16* %input_24_copy_0, i16* %input_24_copy_1, i256* %layer5_out_copy3)
  call void @copy_back([2 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %0, i16* %input_24_copy_0, i16* %input_24_copy_1, [16 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %1, i256* %layer5_out_copy3)
  ret void
}
