...
HLS_SOURCES = ../../../../../../../../vck/NN_on_FPGA/decoder/decoder_hls/decoder_test.cpp ../../../../../../../../vck/NN_on_FPGA/decoder/decoder_hls/firmware/decoder.cpp
...
$(ObjDir)/decoder_test.o: ../../../../../../../../vck/NN_on_FPGA/decoder/decoder_hls/decoder_test.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../../../../vck/NN_on_FPGA/decoder/decoder_hls/decoder_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/decoder_test.d

$(ObjDir)/decoder.o: ../../../../../../../../vck/NN_on_FPGA/decoder/decoder_hls/firmware/decoder.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../../../../vck/NN_on_FPGA/decoder/decoder_hls/firmware/decoder.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
