...
HD_PWD='C:/Users/Vansh/vck/NN_on_FPGA/autoencoder/autoencoder.runs/autoencoder_rst_clk_wiz_100M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log autoencoder_rst_clk_wiz_100M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source autoencoder_rst_clk_wiz_100M_1.tcl
