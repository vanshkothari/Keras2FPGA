...
HD_PWD='C:/Users/Vansh/vck/NN_on_FPGA/autoencoder/autoencoder.runs/snr_mult_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log snr_mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source snr_mult.tcl
