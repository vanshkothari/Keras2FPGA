...
HD_PWD='C:/Users/Vansh/vck/NN_on_FPGA/autoencoder/autoencoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log autoencoder_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source autoencoder_wrapper.tcl
