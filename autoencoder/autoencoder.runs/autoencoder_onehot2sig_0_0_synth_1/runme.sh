...
HD_PWD='C:/Users/Vansh/vck/NN_on_FPGA/autoencoder/autoencoder.runs/autoencoder_onehot2sig_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log autoencoder_onehot2sig_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source autoencoder_onehot2sig_0_0.tcl
