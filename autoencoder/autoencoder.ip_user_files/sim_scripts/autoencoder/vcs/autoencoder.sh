...
design_libs=(xil_defaultlib lib_cdc_v1_0_3 proc_sys_reset_v5_0_15)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.autoencoder xil_defaultlib.glbl -o autoencoder_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./autoencoder_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key autoencoder_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc autoencoder_simv.daidir vcs_lib c.obj)
