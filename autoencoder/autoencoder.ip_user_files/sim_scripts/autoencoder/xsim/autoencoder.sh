...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_15 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot autoencoder xil_defaultlib.autoencoder xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim autoencoder -key {Behavioral:sim_1:Functional:autoencoder} -tclbatch cmd.tcl -protoinst "protoinst_files/autoencoder.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb autoencoder.wdb xsim.dir libdpi.so)
