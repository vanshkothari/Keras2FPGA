...
#
# Script generated by Vivado on Wed Jul 24 00:02:21 +0530 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : snr_mult.sh
...
#
# Usage        : snr_mult.sh
#                snr_mult.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                snr_mult.sh [-reset_run]
#                snr_mult.sh [-reset_log]
#                snr_mult.sh [-help]
#
...
# script info
echo -e "snr_mult.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./snr_mult.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_13 -L xbip_pipe_v3_0_9 -L xbip_bram18k_v3_0_9 -L mult_gen_v12_0_21 -L xil_defaultlib -L secureip -L xpm --snapshot snr_mult xil_defaultlib.snr_mult -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim snr_mult -key {Behavioral:sim_1:Functional:snr_mult} -tclbatch cmd.tcl -protoinst "protoinst_files/autoencoder.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb snr_mult.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./snr_mult.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: snr_mult.sh [-help]\n\
Usage: snr_mult.sh [-step]\n\
Usage: snr_mult.sh [-lib_map_path]\n\
Usage: snr_mult.sh [-reset_run]\n\
Usage: snr_mult.sh [-reset_log]\n\
Usage: snr_mult.sh [-keep_index]\n\
Usage: snr_mult.sh [-noclean_files]\n\n\
