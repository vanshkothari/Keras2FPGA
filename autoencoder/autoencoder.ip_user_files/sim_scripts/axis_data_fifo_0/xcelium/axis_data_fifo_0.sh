...
design_libs_elab="-libname axis_infrastructure_v1_1_1 -libname axis_data_fifo_v2_0_13 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver axis_infrastructure_v1_1_1 axis_data_fifo_v2_0_13 xil_defaultlib)
...
compile()
{
  ...
  xmvlog -work axis_data_fifo_v2_0_13 $xmvlog_opts +incdir+"../../../ipstatic/hdl" \
