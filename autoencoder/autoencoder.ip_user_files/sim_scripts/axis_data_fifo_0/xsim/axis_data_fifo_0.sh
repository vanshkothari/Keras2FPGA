...
#
# Script generated by Vivado on Mon Jul 22 17:49:58 +0530 2024
...
# script info
echo -e "axis_data_fifo_0.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_13 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axis_data_fifo_0 xil_defaultlib.axis_data_fifo_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axis_data_fifo_0 -key {Behavioral:sim_1:Functional:axis_data_fifo_0} -tclbatch cmd.tcl -protoinst "protoinst_files/autoencoder.protoinst" -log simulate.log
}
